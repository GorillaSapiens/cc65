...
static const InsTable InsTabNone = { 0, NULL };

/* Instruction table for the 6502 */
static const InsDesc Ins6502[] = {
...
static const InsTable InsTab6502 = {
    sizeof (Ins6502) / sizeof (Ins6502[0]),
    Ins6502
};

/* Instruction table for the 6502 with illegal instructions */
static const InsDesc Ins6502X[] = {
   { "ADC",  0x080A26C, 0x60, 0, PutAll },
...
static const InsTable InsTab6502X = {
    sizeof (Ins6502X) / sizeof (Ins6502X[0]),
    Ins6502X
};
...
*/
static const InsDesc Ins6502DTV[] = {
   { "ADC",  0x080A26C, 0x60, 0, PutAll },
   { "ALR",  0x0800000, 0x4B, 0, PutAll },         /* X */
   { "ANC",  0x0800000, 0x0B, 0, PutAll },         /* X */
   { "AND",  0x080A26C, 0x20, 0, PutAll },
...
static const InsTable InsTab6502DTV = {
    sizeof (Ins6502DTV) / sizeof (Ins6502DTV[0]),
    Ins6502DTV
};

/* Instruction table for the 65SC02 */
static const InsDesc Ins65SC02[] = {
...
static const InsTable InsTab65SC02 = {
    sizeof (Ins65SC02) / sizeof (Ins65SC02[0]),
    Ins65SC02
};

/* Instruction table for the 65C02 */
static const InsDesc Ins65C02[] = {
   { "ADC",  0x080A66C, 0x60, 0, PutAll },
   { "AND",  0x080A66C, 0x20, 0, PutAll },
   { "ASL",  0x000006e, 0x02, 1, PutAll },
...
static const InsTable InsTab65C02 = {
    sizeof (Ins65C02) / sizeof (Ins65C02[0]),
    Ins65C02
};

/* Instruction table for the 4510 */
static const InsDesc Ins4510[] = {
   { "ADC",  0x080A66C, 0x60, 0, PutAll },
   { "AND",  0x080A66C, 0x20, 0, PutAll },
   { "ASL",  0x000006e, 0x02, 1, PutAll },
...
static const InsTable InsTab4510 = {
    sizeof (Ins4510) / sizeof (Ins4510[0]),
    Ins4510
};

/* Instruction table for the 65816 */
static const InsDesc Ins65816[] = {
...
static const InsTable InsTab65816 = {
    sizeof (Ins65816) / sizeof (Ins65816[0]),
    Ins65816
};

/* Instruction table for the SWEET16 pseudo CPU */
static const InsDesc InsSweet16[] = {
...
static const InsTable InsTabSweet16 = {
    sizeof (InsSweet16) / sizeof (InsSweet16[0]),
    InsSweet16
};

/* Instruction table for the HuC6280 (the CPU used in the PC engine) */
static const InsDesc InsHuC6280[] = {
   { "ADC",  0x080A66C, 0x60, 0, PutAll },
   { "AND",  0x080A66C, 0x20, 0, PutAll },
   { "ASL",  0x000006e, 0x02, 1, PutAll },
   { "BBR0", 0x0000000, 0x0F, 0, PutBitBranch },
...
static const InsTable InsTabHuC6280 = {
    sizeof (InsHuC6280) / sizeof (InsHuC6280[0]),
    InsHuC6280
};
...
*/
{
    if (LongJsrJmpRts) {
        ...
        InsDesc InsAbs = *Ins;
        *((unsigned long *) &(InsAbs.AddrMode)) &= ~(AM65_ABS_LONG);
        PutJMP (&InsAbs);
    }
}
